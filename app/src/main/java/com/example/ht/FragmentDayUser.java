...
public class FragmentDayUser extends Fragment {
    TextView textDay;
    TextView textDate;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_day_user, container, false);
    }

    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState){
        textDay = view.findViewById(R.id.textDayTitle);
        textDate = view.findViewById(R.id.textDayUserDate);
